...
export default function Register() {
    ...
    const submitHandler = (e) => {
        ...
        //Envoyer le formData à notre RegisterAction
    ...
    return (
        ...
        <form onSubmit={submitHandler} className="shadow-lg" encType='multipart/form-data'>
            <h1 className="mb-3 text-white">Inscription</h1>
          ...
          <div className="form-group">
            ...
            <div className="form-group">
              <label htmlFor="email_field" className="text-white">Adresse e-mail</label>
                <input
            ...
            <div className='form-group'>
              ...
              <div className='d-flex align-items-center'>
                  ...
                  <div className='custom-file'>
                      ...
                      />
                    <label className='custom-file-label text-white' htmlFor='customFile'>
